...
<div>
    ...
    <h3 style="text-align:left;">Editar permissão</h3>
    <hr>
    <form method="post" action="?p=44">
        <div style="margin-top: 0.5rem; line-height: 2;">
            ...
            <div>
                <p>Tag</p>
                <input class="input-long-text" type="text" placeholder="Enter Tag.." name="tag" value="<?= $row['tag'] ?>" required>
            </div>
            <div>
                <p>Descrição</p>
